...
import 'package:levv4/view/enviar/mapa/open_map_widget.dart';
import 'package:levv4/view/localizar/localizar/localizar.dart';
import '../../../../model/bo/endereco/endereco.dart';


class ItemEndereco extends StatefulWidget {
  ItemEndereco(
      {Key? key,
  ...
  @override
  State<ItemEndereco> createState() => _ItemEnderecoState();
}

class _ItemEnderecoState extends State<ItemEndereco> {
