...
class CadastroDePerfilEntregar extends StatefulWidget {
  const CadastroDePerfilEntregar(
  ...
  @override
  State<CadastroDePerfilEntregar> createState() =>
      _CadastroDePerfilEntregarState();
}

class _CadastroDePerfilEntregarState extends State<CadastroDePerfilEntregar> {
